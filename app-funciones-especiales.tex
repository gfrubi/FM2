...
\subsubsection{Ecuación diferencial (forma de Sturm-Liouville)}
...
\subsubsection{Aplicación en Física}
\begin{itemize}
\item Solución radial de ecuación de Schr\"odinger en potencial de Coulomb (átomo hidrogenoide).
\end{itemize}
...
\subsubsection{Aplicación en Física}
\begin{itemize}
\item Oscilador armónico cuántico
\end{itemize}
...
\subsubsection{Aplicación en Física}
\begin{itemize}
\item Solución numérica de ecuaciones de fluidos.
\end{itemize}