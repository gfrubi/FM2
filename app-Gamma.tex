\chapter{Función Gamma}\label{app-Gamma}
\begin{equation}
...
\caption{La función $\Gamma$ con argumento real. Código Python \href{https://github.com/gfrubi/FM2/blob/master/figuras-editables/fig-Gamma.py}{aquí}.}
\label{fig-Gamma}
\end{figure}
