...
\end{equation}
Esto significa que las \textit{funciones de Bessel son los coeficientes de la expansión en serie de Fourier de la función} $e^{iz\sen\theta}$. Por lo tanto,
\begin{equation}
...
\end{equation}
Como $e^{i(z\sen\theta-n\theta)}=\cos(z\sen\theta-n\theta)+i\sen(z\sen\theta-n\theta)$, vemos que el integrando se divide en una contribución par y otra impar en $\theta$. Por lo tanto,
\begin{equation}
