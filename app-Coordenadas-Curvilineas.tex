...
\section{Coordenadas Cilíndricas}\label{appcoorcilin}
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.6]{figs/Coordenadas-Cilindricas.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{figs/volumen-cilindricas.pdf}
...
\section{Coordenadas Esféricas}\label{appcooresfe}
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.5]{figs/Coordenadas-Esfericas.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{figs/volumen-esfericas.pdf}
